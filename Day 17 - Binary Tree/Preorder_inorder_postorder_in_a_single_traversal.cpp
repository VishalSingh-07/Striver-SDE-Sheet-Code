...
- The function returns a vector of vectors, where the first vector is the Inorder traversal,  
  the second vector is the Preorder traversal, and the third vector is the Postorder traversal.
